...
export function createParleyEmbeddedClient(options = {}) {
  ...
  return {
    ...
    getPlanOverview: (input = {}, options = {}) => query("getPlanOverview", input, options),
    getPlanPhases: (input = {}, options = {}) => query("getPlanPhases", input, options),
    getPlanReviewStatus: (input = {}, options = {}) => query("getPlanReviewStatus", input, options),
    getPlanRelationships: (input = {}, options = {}) => query("getPlanRelationships", input, options),
    getPlanStatus: (input = {}, options = {}) => query("getPlanStatus", input, options),
