...
- board projections: board overview, checkpoint projection
- obligations: runtime obligations, board obligations
...
Dashboard and agent clients should consume service projections/read models rather than scraping OpenClaw runtime state or private storage. Initial read models should include:
